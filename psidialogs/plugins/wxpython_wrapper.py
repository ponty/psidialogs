...
class Backend(IPlugin):
    ...
    def message(self, args):
        self.init()
        self.wx.lib.dialogs.messageDialog(message=args.message, title=args.title, aStyle=self.wx.OK | self.wx.CENTRE)

    def warning(self, args):
        self.init()
        self.wx.lib.dialogs.messageDialog(message=args.message, title=args.title, aStyle=self.wx.OK | self.wx.CENTRE | self.wx.ICON_WARNING)

    def error(self, args):
        self.init()
        self.wx.lib.dialogs.messageDialog(message=args.message, title=args.title, aStyle=self.wx.OK | self.wx.CENTRE | self.wx.ICON_ERROR)
# #        self.wx.lib.dialogs.alertDialog(message=args.message, title=args.title)
    ...
    def ask_yes_no(self, args):
        self.init()
        result = self.wx.lib.dialogs.messageDialog(message=args.message, title=args.title, aStyle=self.wx.YES | self.wx.NO | self.wx.CENTRE | self.wx.YES_DEFAULT)
        return result.accepted
