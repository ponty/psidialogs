...
from backend_api import all_backends, set_backend, get_backend
from pcdialogs import backend_api
...
def ask_files(message='Select files for open.', default='', title=''):
    """
    A dialog to get a list of file paths.
    The "default" argument specifies a list of files.
    
    return None if he cancels the selection selection.

    :param message: message to be displayed.
    :param title: window title
    :param default: default list of file paths
